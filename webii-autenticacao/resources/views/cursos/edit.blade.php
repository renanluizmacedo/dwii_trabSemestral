    ...
    <div class="row">
        <div class="container my-3">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @if($errors->has('nome')) is-invalid @endif" name="nome" value="{{$dados->nome}}" placeholder="Nome" />
            ...
            <div class="row">
                <div class="col">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @if($errors->has('sigla')) is-invalid @endif" name="sigla" placeholder="Sigla" value="{{$dados->sigla}}" />
            ...
            <div class="row">
                <div class="col">
                    <div class="form-floating mb-3">
                        <input type="number" min="1" max="5" class="form-control @if($errors->has('tempo')) is-invalid @endif" name="tempo" placeholder="Tempo" value="{{$dados->tempo}}" />
